...
The Apigee Discovery Agent is built and distributed as a docker container. To execute the container the following command may be executed, updating the version.
